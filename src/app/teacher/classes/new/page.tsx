  ...
  return (
    <div className="max-w-3xl mx-auto">
      <div className="mb-6">
        ...
        <p className="text-gray-500 mt-1">Set up a new class and enroll students</p>
      </div>
        ...
        <div className="p-6 md:p-8 space-y-6">
          ...
          <div>
            ...
            <input
              type="text"
              required
              placeholder="e.g., Conversational Russian B1"
          ...
          <div>
            <label className="block text-sm font-medium text-gray-900 mb-1.5 flex justify-between items-end">
              ...
              <span className="text-xs font-normal text-gray-500">{formData.studentIds.length} selected</span>
            </label>
            
            <div className="border border-gray-200 rounded-lg overflow-hidden">
              <div className="max-h-60 overflow-y-auto divide-y divide-gray-100 bg-gray-50">
                {students.length === 0 ? (
