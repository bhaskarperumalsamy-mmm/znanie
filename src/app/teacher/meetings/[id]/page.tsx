  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <div>
          <Link href="/teacher/meetings" className="text-[#c1121f] hover:text-[#b5110a] text-sm">
            ← Back to Meetings
          </Link>
        ...
        <div className="space-y-6">
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            {meeting.status === 'COMPLETED' && (
              <Link
                href={`/teacher/meetings/${meetingId}/notes`}
                className="block w-full px-4 py-2 bg-[#c1121f] text-white rounded-lg hover:bg-[#b5110a] text-center"
              >
                Add Notes
              </Link>
            )}
