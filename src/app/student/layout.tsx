...
export default function StudentLayout({
  ...
  // Second check: user loaded but auth not yet verified - retry
  if (!user && !authChecked) {
    setAuthChecked(true);
    return (
  ...
  // Third check: after retry, still no user
  if (!user && authChecked) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50">
        <div className="animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-[#c1121f] mb-4"></div>
  ...
  const navItems = [
    ...
    { href: '/student/meetings', label: 'My Meetings', icon: 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z' },
    { href: '/student/book', label: 'Book Meeting', icon: 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z' },
    { href: '/student/teachers', label: 'Browse Teachers', icon: 'M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z' },
    { href: '/student/analytics', label: 'Analytics', icon: 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z' },
      ...
      <aside className={`${collapsed ? 'w-20' : 'w-64'} fixed h-full bg-white border-r border-gray-200 transition-all duration-300`}>
        ...
        <div className="p-5 border-b border-gray-100">
          <div className="flex items-center justify-between">
            {!collapsed && (
              <Link href="/student" className="text-xl font-bold text-[#c1121f]">
                ZNANIE
              </Link>
            )}
            <button 
          ...
          {!collapsed && (
            <p className="text-xs text-gray-400 mt-1 font-medium">STUDENT PORTAL</p>
          )}
        </div>
