      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div>
              <h3 className="font-semibold text-gray-900">Book Meeting</h3>
              <p className="text-gray-500 text-sm">Schedule a session</p>
            </div>
          </div>
        </Link>
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div>
              <h3 className="font-semibold text-gray-900">Browse Teachers</h3>
              <p className="text-gray-500 text-sm">Find a teacher</p>
            </div>
          </div>
        </Link>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100">
        <div className="p-6 border-b border-gray-100">
          <div className="flex items-center justify-between">
            ...
            <Link href="/student/meetings" className="text-[#c1121f] hover:text-[#b5110a] text-sm font-medium">
              View All →
            </Link>
          </div>
        </div>
        ...
        {meetings.length === 0 ? (
          <div className="p-12 text-center">
            ...
            <Link href="/student/book" className="text-[#c1121f] hover:text-[#b5110a] font-medium">
              ...
              >
                <div className="flex-1">
                  ...
                  <p className="text-gray-500 text-sm mt-1">
                    {meeting.teacher.name} • {formatDate(meeting.startTime)}
                  </p>
                </div>
